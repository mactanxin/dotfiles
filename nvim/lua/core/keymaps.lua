...
mapkey("n", "<leader>fc", "<cmd>Telescope git_commits<CR>", opts)
mapkey("n", "<leader>fb", "<cmd>Telescope buffers<cr>", opts)
mapkey("n", "<leader>fh", "<cmd>Telescope help_tags<cr>", opts)
mapkey("n", "<leader>ft", "<cmd>Telescope notify<cr>", opts)
maplua("<leader>fs", "require('session-lens').search_session()")
mapkey("n", "<leader>fe", "<cmd>Telescope file_browser<cr>", opts)
